...
#include "../common.h" // For logging macros // Corrected from 'include' to '#include'

#define MODULE_NAME "SESSION" // This specific MODULE_NAME definition is now the only one
